...
; Constants
;*****************
.equ Val_del1=0x50;величина константы задержки
.equ Val_del2=0x00;(защитной паузы) 
.equ Val_del3=0x00;(частота 8мГц,5 тактов*80 -задержка 50 мкс)
...
Start: sbic PinB,4 ;проверка условия, что нажата кнопка
	...
	cpi counter,10 ;проверка, что Counter=10?
