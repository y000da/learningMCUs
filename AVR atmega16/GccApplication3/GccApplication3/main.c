...
#define DEB_NUM 30		//количество переполнений Т0 для подавления дребезга

/***********************************************************************
	Глобальные переменные
************************************************************************/
unsigned char maxCounter = MAX_VEL;	//максимальное значение для счетчика counter
unsigned char counter = MAX_VEL;			//счетчик числа переполнений Т0
...
unsigned char flagInt1 = 0;			//флаг активности подавления дребезга от кнопки INT1
									//(0 - дребезг подавлен, 1 - идет подавление дребезга)
unsigned char direction = 1;		//флаг направления движения бегущего огонька 0 - сверху вниз
